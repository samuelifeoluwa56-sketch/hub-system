...
async function listBanks() {
  const { data } = await axios.get(`${BASE}/bank?currency=NGN`, { headers: HEADERS });
...
module.exports = { initializePayment, verifyPayment, createRecipient, sendTransfer, listBanks, resolveAccount };
